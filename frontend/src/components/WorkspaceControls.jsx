    ...
    <aside className="glass rounded-[2.2rem] p-5">
      ...
      {!lessonControlsEnabled || !visibleControls.showPrimaryAction ? (
        <div className="mt-2 text-xs leading-relaxed text-slate-500">
          {guidedSessionActive
            ? "Stay in conversation mode for this phase. Controls will appear when the lesson needs them."
      ...
      {guidedSessionActive && suggestedActions.length ? (
        <div className="mt-3 rounded-[1.4rem] border border-slate-300 bg-white px-3 py-3">
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            {suggestedActions.slice(0, 3).map((action) => (
              <button
                ...
                className="rounded-full border border-slate-300 bg-[#f8f9fb] px-3 py-1.5 text-xs font-medium text-slate-700 transition hover:bg-slate-100"
              >
